// Code generated by 'ccgo -o cnk/nk_386.go nuklear/nuklear.c -export-externs X -export-fields  -export-defines  -export-enums  -export-typedefs  -export-structs  -pkgname cnk', DO NOT EDIT.
