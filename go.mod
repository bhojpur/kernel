module github.com/bhojpur/kernel
...
require (
	...
	github.com/layer-x/layerx-commons v0.0.0-20181130152826-a9e7080c9402
	...
	gvisor.dev/gvisor v0.0.0-20220415231138-4efada5eb70f
)
